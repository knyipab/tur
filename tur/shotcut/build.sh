...
TERMUX_PKG_DEPENDS="ffmpeg, mlt, qt6-qtbase, qt6-qtcharts, qt6-qtdeclarative, qt6-qtimageformats, qt6-qtmultimedia, qt6-qttranslations, fftw, frei0r-plugins, sdl, sdl2"
