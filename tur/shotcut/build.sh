...
TERMUX_PKG_DEPENDS="ffmpeg, fftw, frei0r-plugins, mlt, movit, libx264, libvpx, lame, ladspa, qt6-qtbase, qt6-qtcharts, qt6-qtdeclarative, qt6-qtimageformats, qt6-qtmultimedia, qt6-qttranslations, sdl, sdl2"
