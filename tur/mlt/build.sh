...
TERMUX_PKG_BUILD_DEPENDS="ffmpeg, fftw, fontconfig, frei0r-plugins, gdk-pixbuf, glib, jack-dummy, ladspa-sdk, libepoxy, libexif, libglvnd, libsamplerate, libvorbis, libx11, libxml2, opencv, qt6-qtbase, qt6-qtsvg, sdl, sdl2, swig"
# TERMUX_PKG_BUILD_DEPENDS="ffmpeg, fftw, fontconfig, frei0r-plugins, gdk-pixbuf, glib, jack-dummy, ladspa-sdk, libepoxy, libexif, libglvnd, libsamplerate, libvorbis, libx11, libxml2, opencv, qt6-qtbase, qt6-qtsvg, pango, python, rubberband, sdl2, sdl-image, sdl, sox, zlib"
