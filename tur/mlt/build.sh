...
# TODO: movit (not avialable), opencv (incurring QPrivate compile error)
TERMUX_PKG_BUILD_DEPENDS="ffmpeg, fftw, fontconfig, frei0r-plugins, gdk-pixbuf, glib, jack-dummy, ladspa-sdk, libepoxy, libexif, libglvnd, libsamplerate, libvorbis, libx11, libxml2, qt6-qtbase, qt6-qtsvg, pango, python, rtaudio, rubberband, sdl, sdl2, sdl-image, sox, vid.stab, zlib"
