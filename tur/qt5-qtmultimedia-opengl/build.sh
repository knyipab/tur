...
TERMUX_PKG_DEPENDS="libc++, qt5-qtbase-opengl, pulseaudio, openal-soft, gstreamer, gst-plugins-base, gst-plugins-bad"
TERMUX_PKG_BUILD_DEPENDS="qt5-qtbase-opengl-cross-tools"
TERMUX_PKG_BUILD_IN_SRC=true
TERMUX_PKG_NO_STATICSPLIT=true
TERMUX_PKG_CONFLICTS="qt5-qtmultimedia"
TERMUX_PKG_REPLACES="qt5-qtmultimedia"
TERMUX_PKG_PROVIDES="qt5-qtmultimedia"
