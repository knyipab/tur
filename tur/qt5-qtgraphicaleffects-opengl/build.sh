...
TERMUX_PKG_BUILD_DEPENDS="qt5-qtbase-opengl-cross-tools, qt5-qtdeclarative-opengl-cross-tools"
TERMUX_PKG_BUILD_IN_SRC=true
TERMUX_PKG_CONFLICTS="qt5-qtgraphicaleffects"
TERMUX_PKG_REPLACES="qt5-qtgraphicaleffects"
TERMUX_PKG_PROVIDES="qt5-qtgraphicaleffects"
